            ...
            {kbContent?.tags && kbContent.tags.length > 0 && (
              <div className="mt-2 flex flex-wrap gap-1">
                {kbContent.tags.map((tag, index) => (
                  <span
                    key={index}
                    className="px-2 py-0.5 text-xs bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300 rounded"
                  >
                    {tag}
                  </span>
                ))}
          ...
          <div className="flex-1 overflow-y-auto p-4">
            {isLoading ? (
              ...
              <div className="text-center text-red-600 py-8">
                ...
                <button
                  onClick={refreshKb}
                  className="mt-4 px-4 py-2 bg-gradient-to-r from-green-500 to-teal-500 text-white rounded hover:shadow-lg transition-shadow"
                >
                  Retry
                </button>
              </div>
