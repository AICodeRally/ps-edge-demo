...
// Mock data for offline mode - nonprofit consulting focus
function getMockPulseItems(): PulseItem[] {
  return [
    ...
    },
    {
      ...
      message: 'Phoenix Foundation completed their strategic planning phase. NPS score: 9/10. Good time for follow-on engagement.',
      urgency: 'low',
      category: 'info',
