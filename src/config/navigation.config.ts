    ...
    pages: [
      {
        ...
        description: 'AI tools for nonprofit consulting (OpsChief, AskPS for sector insights)',
        legacyHref: '/dashboard/operations/ai',
      },
      {
        name: 'Integrations',
        href: '/dashboard/practice/integrations',
        description: 'Consulting tools and nonprofit donor management system connectors',
        legacyHref: '/dashboard/operations/integrations',
      },
      {
        name: 'Data Management',
        href: '/dashboard/practice/data',
        description: 'Nonprofit client data quality and engagement analytics',
        legacyHref: '/dashboard/operations/data',
      },
      {
        name: 'Tenant Management',
        href: '/dashboard/practice/tenants',
        description: 'NP-Edge nonprofit customer portal and health monitoring',
        legacyHref: '/dashboard/partner-portal/tenants',
      },
      {
        name: 'Usage Analytics',
        href: '/dashboard/practice/usage',
        description: 'Platform usage tracking for nonprofit client deployments',
      },
    ],
  },
  {
