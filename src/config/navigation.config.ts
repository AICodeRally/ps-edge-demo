...
export const SIX_PS_NAVIGATION: PNavigation[] = [
  ...
  },
  {
    category: 'PLATFORM',
    slug: 'platform',
    landingPageHref: '/dashboard/platform',
    pages: [
      {
        name: 'AI Management',
        href: '/dashboard/platform/ai',
        description: 'Manage AI tools and agents',
      ...
      },
      {
        ...
        href: '/dashboard/platform/data',
        description: 'Data sources and pipelines',
        legacyHref: '/dashboard/operations/data',
      },
      {
        name: 'API Usage',
        href: '/dashboard/platform/usage',
        description: 'API usage monitoring and logs',
