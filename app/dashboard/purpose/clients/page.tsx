      ...
      <div className="flex-1 overflow-auto p-6">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="card p-8 text-center">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">👥 Clients</h2>
            <p className="text-gray-600 dark:text-gray-400">Detailed client directory and relationships view - Coming soon</p>
          </div>
        </div>
      </div>
    </div>
